...
python -c "import requests, telegram, firebase_admin, schedule; print('✅ Tous les modules OK')"
```
...
### Remarques
Le bot ne requiert plus Chrome/Selenium. Le scraping utilise HTTP (requests + BeautifulSoup) et fonctionne en environnements cloud sans navigateur.
